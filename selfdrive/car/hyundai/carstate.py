...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp2, cp_cam):
    ...
    if self.car_fingerprint in [CAR.GENESIS, CAR.PALISADE, CAR.GENESIS_G90, CAR.GENESIS_G90_L, CAR.K7]: # 현재 오토 홀드를 표시하기 위한 작업
    ...
    if self.car_fingerprint in [CAR.GENESIS, CAR.PALISADE, CAR.GENESIS_G90, CAR.GENESIS_G90_L, CAR.K7]: # 현재 기어 단수를 표시하기 위한 작업
